...
INFO_TELEGRAM = "t.me/ffnyxff"
INFO_ALT = "DEVOLAPER:@ffnyxff"
...
# Ana sayfa  # HTML dosyasını ayrıca oluşturmanız gerekir
...
def tcgsm_api():
    ...
    url = f"https://zyrdaware.xyz/api/tcgsm?=t.me/zyrdaware&tc={tc}"
...
def ip_api():
    ...
    for service, url in apis.items():
        try:
            headers = {
                "User-Agent": "Mozilla/5.0 (IP Sorgu API - t.me/ffnyxff)"
            }
            response = requests.get(url, headers=headers, timeout=10)
            results[service] = {
...
<head>
    ...
    <title>FFNYXFF APİ SERVİS</title>
    ...
    <div class="container">
        ...
        <div class="contact-section">
            ...
            <div class="contact-buttons">
                <a href="https://t.me/ffnyxff" target="_blank" class="contact-btn">
